...
replace (
	github.com/elastic/go-docappender => github.com/carsonip/go-docappender v1.0.1-0.20240312173335-533abc382d1b
	...
	go.opentelemetry.io/collector/exporter => go.opentelemetry.io/collector/exporter v0.96.1-0.20240312113120-fbc0ce074899
)
